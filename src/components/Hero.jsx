  ...
  return (
    <div className="min-h-screen bg-[url(src/assets/images/bg.png)] bg-cover bg-center text-white">
      <nav className="flex items-center justify-between px-6 py-4">
        ...
        <button className="bg-white text-blue-800 px-4 py-2 rounded-full font-semibold text-sm cursor-pointer hover:bg-gray-100">
          Get Started →
        </button>
      </nav>
      <div className="flex flex-col-reverse md:flex-row items-center justify-between px-6 md:px-16 py-12 md:py-20">
        <div className="max-w-xl">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">
            Easily Compare <br />
            <span className="text-white">Energy, Gas, And <br/> Internet Plans</span>
          </h1>
          ...
          <div className="bg-white rounded-full p-1 flex items-center w-full max-w-md shadow-lg font-helvetica">
            ...
            />
            <button className="bg-blue-500 cursor-pointer hover:bg-blue-600 text-white px-6 py-2 rounded-full text-sm">
              Compare →
            </button>
          </div>
        </div>
